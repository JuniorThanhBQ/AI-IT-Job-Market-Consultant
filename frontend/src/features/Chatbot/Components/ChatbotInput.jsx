    ...
    <div className="mt-6 border-t border-slate-150 dark:border-slate-800 pt-5 flex flex-col gap-2 shrink-0">
      ...
      >
        <input
          ...
          className="flex-1 bg-white/80 dark:bg-slate-900/60 border border-slate-200 dark:border-slate-850 rounded-2xl px-6 py-4 outline-none focus:ring-2 focus:ring-[#285872] focus:border-transparent transition-all text-xs font-bold text-slate-900 dark:text-white placeholder-slate-400"
          disabled={isSending}
        />
        <button
          type="submit"
