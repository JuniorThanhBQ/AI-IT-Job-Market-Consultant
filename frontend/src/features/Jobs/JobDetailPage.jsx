...
export default function JobDetailPage({ params }) {
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-955 relative overflow-x-hidden font-sans pb-16">
                  ...
                  <div className="flex flex-wrap items-center gap-x-3 gap-y-1.5">
                    ...
                    {job.company_id && (
                      <button
                        ...
                        className="text-xs bg-[#285872]/10 hover:bg-[#285872]/20 dark:bg-slate-800 dark:hover:bg-[#285872]/20 text-[#285872] dark:text-[#407c9c] border border-slate-200 dark:border-slate-700 rounded-lg px-2.5 py-1 font-extrabold transition-all cursor-pointer"
                      >
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              ...
              <div className="bg-white/80 dark:bg-slate-900/40 border border-slate-200 dark:border-slate-900 rounded-2xl p-5 backdrop-blur-md">
                ...
                <p className="text-sm font-bold text-slate-700 dark:text-slate-200 flex items-center gap-1.5 uppercase">
                  <User className="w-4 h-4 text-[#285872] dark:text-[#407c9c]" />
              ...
              <div className="bg-white/80 dark:bg-slate-900/40 border border-slate-200 dark:border-slate-900 rounded-2xl p-5 backdrop-blur-md">
                ...
                <p className="text-sm font-bold text-slate-700 dark:text-slate-200 flex items-center gap-1.5 uppercase">
                  <Briefcase className="w-4 h-4 text-[#285872] dark:text-[#407c9c]" />
              ...
              <div className="bg-white/80 dark:bg-slate-900/40 border border-slate-200 dark:border-slate-900 rounded-2xl p-5 backdrop-blur-md">
                ...
                <p className="text-sm font-bold text-slate-700 dark:text-slate-200 flex items-center gap-1.5">
                  <Clock className="w-4 h-4 text-[#285872] dark:text-[#407c9c]" />
                  {mapWorkingHours(job.working_hours, locale)}
                </p>
              </div>
            </div>
