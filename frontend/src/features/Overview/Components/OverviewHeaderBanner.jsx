...
export default function OverviewHeaderBanner({
  ...
  return (
    <div className="flex flex-col md:flex-row md:items-center justify-between border-b border-slate-200 dark:border-slate-800 pb-6 gap-4">
      ...
      <div className="flex w-full md:w-auto bg-slate-100 dark:bg-slate-950 p-1 rounded-2xl border border-slate-200 dark:border-slate-850">
        <button
          onClick={() => setActiveTab("dashboard")}
          className={`flex-1 md:flex-none px-4 md:px-5 py-2 rounded-xl text-xs font-bold transition-all cursor-pointer ${
            activeTab === "dashboard"
