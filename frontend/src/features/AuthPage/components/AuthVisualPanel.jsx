...
export default function AuthVisualPanel({ t, isLogin, onToggle }) {
  return (
    <motion.div
      layout
      className="hidden md:flex w-1/2 relative bg-[#285872] text-white items-center justify-center p-16 overflow-hidden shrink-0"
    >
      ...
      <AnimatePresence mode="wait">
        {isLogin ? (
          ...
          >
            <h3 className="text-4xl lg:text-5xl font-black tracking-tighter uppercase mb-6 leading-tight">
              {t("visual_login_heading")}
            </h3>
            <p className="text-[#eef4f7] text-lg font-medium leading-relaxed mb-10">
              {t("visual_login_desc")}
            </p>
