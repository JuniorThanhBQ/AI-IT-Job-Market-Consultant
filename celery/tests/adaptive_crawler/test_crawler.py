...
class TestRunCrawlerForSite:
    @patch("tools.adaptive_crawler.crawler.SITE_CRAWL_TIMEOUT_SECONDS", 10.0)
    ...
    @patch("tools.adaptive_crawler.crawler.SITE_CRAWL_TIMEOUT_SECONDS", 0.01)
...
class TestMainCrawlerLoop:
    ...
    @patch("tools.adaptive_crawler.crawler.LocalEventManager.from_config")
    @patch("tools.adaptive_crawler.crawler.create_async_engine")
    @patch("tools.adaptive_crawler.crawler.SQLModel.metadata.create_all")
