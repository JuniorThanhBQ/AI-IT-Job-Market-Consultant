...
* Maintenance: Fixing workflow deploy production failure. PR [#121](https://github.com/JuniorThanhBQ/AI-IT-Job-Market-Consultant/pull/121) by [@JuniorThanhBQ](https://github.com/JuniorThanhBQ).
...
* ⬆ Update crawlee[all] requirement from >=1.8.2 to >=1.8.3. PR [#44](https://github.com/JuniorThanhBQ/AI-IT-Job-Market-Consultant/pull/44) by [@dependabot[bot]](https://github.com/apps/dependabot).
...
* ⬆ Bump the github-actions group with 9 updates. PR [#12](https://github.com/JuniorThanhBQ/AI-IT-Job-Market-Consultant/pull/12) by [@dependabot[bot]](https://github.com/apps/dependabot).
* Project repository core template ready for development.

## 0.1.0 (2026-07-18)

* Initial project templates, Next.js frontend, FastAPI backend, and multi-agent LangGraph orchestration scaffolding configured.
